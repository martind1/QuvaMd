    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ServerPrinter>(entity =>
        {
            ...
            entity.Property(e => e.CreateUser)
                ...
                .IsUnicode(false)
                .HasColumnName("CREATE_USER");
            entity.Property(e => e.MaschineName)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("MASCHINE_NAME");
            entity.Property(e => e.Name)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("NAME");
        ...
        modelBuilder.Entity<Silo>(entity =>
        {
            ...
            entity.Property(e => e.LockTruck2)
                .IsRequired()
                .HasPrecision(1)
                .HasDefaultValueSql("0 ")
                .HasColumnName("LOCK_TRUCK_2");
            ...
            entity.Property(e => e.Priority)
                .HasPrecision(9)
                .HasColumnName("PRIORITY");
            entity.Property(e => e.ReservedForDry)
                .IsRequired()
                .HasPrecision(1)
                .HasDefaultValueSql("0 ")
                .HasColumnName("RESERVED_FOR_DRY");
            entity.Property(e => e.ReservedForRail)
                .IsRequired()
                .HasPrecision(1)
                .HasDefaultValueSql("0 ")
                .HasColumnName("RESERVED_FOR_RAIL");
        ...
        modelBuilder.HasSequence("IDENTIFICATION_CARD_CODE_SEQ");
